...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("BASLANGIC-->oyun_map.giris_serbest[" + satir + "][" + sutun + "] : "
                + oyun_hareket.oyun_map.giris_serbest[satir][sutun]);
        int yuzluk_sayac = 0;
        while (true) {//oyun_map.getSatir() != 10 yerine  aşağıda bitirecems
            System.out.println("******************************* WHİLE  GİRİYORUZ *******************************");
            System.out.println("*********************************************************************************************");

            satir = oyun_hareket.oyun_map.getSatir();
            sutun = oyun_hareket.oyun_map.getSutun();
 ...
 /*   System.out.println("");
            ...
            System.out.println("******************************************************");
            System.out.println("");*/
            if (!Oyun_hareket.Ilerlenecek_yon_var_mi(satir, sutun) || oyun_hareket.geri_adim_at) {

                int gecici_satir = oyun_hareket.oyun_map.getSatir();
                int gecici_sutun = oyun_hareket.oyun_map.getSutun();
                
                System.out.println("------------(geri adim at : "+oyun_hareket.geri_adim_at+")--------------->>>> Hata verilen yer : satir  : " + satir + " - sutun  : " + sutun);
                System.out.println("satir : " + oyun_hareket.oyun_map.getSatir());
                System.out.println("satir : " + oyun_hareket.oyun_map.getSutun());
                ...
                System.out.println("Satir ve sutun : " + satir + " ----- " + sutun);
                //    System.out.println("suanki satir : " + oyun_hareket.oyun_map.getSatir() + " ve sutun :" + oyun_hareket.oyun_map.getSutun());
                Oyun_hareket.ilerlenecek_Yonleri_belirle(satir, sutun); // hem belirler hemde ilerler
                Oyun_hareket.tek_yonden_ilerlenildi_sonraki_ilerleme_asamasi_iptal_edildi = false;
            }
