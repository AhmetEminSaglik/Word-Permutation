...
public class Calistir extends Thread {
    ...
    public static void Calistir(Oyun_hareket oyun_hareket, int satir, int sutun, String thread_ismi, int Max_Satir, int Max_Sutun,
            int Max_sayi, int karsilastirma) {
